...
class WP_Job_Manager_Ajax {
	...
	public function get_listings() {
		...
		if ( $jobs->post_count && ( $search_location || $search_keywords || $search_categories ) ) {
			$message = sprintf( _n( 'Busqueda completada. Se encontró %d concidencia.', 'Busqueda completada. Se encontraron %d concidencias.', $jobs->found_posts, 'wp-job-manager' ), $jobs->found_posts );
