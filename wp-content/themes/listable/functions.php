...
function getExchangeRate($currency,$price){
	...
	try {
		...
		foreach ( $myposts as $mypost ) {
			$metaValue = get_post_meta( $mypost->ID, 'wpcf-value', true );
			$metaCurrency = get_post_meta( $mypost->ID, 'wpcf-currency', true );
			$metaSymbol = get_post_meta( $mypost->ID, 'wpcf-symbol', true );
