...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main facetwp-template" role="main">
			...
			?>
			<header class="page-header<?php if ( $blog_has_featured_image ) {
				echo ' has-featured-image';
			} ?>">
				<?php if ( $blog_has_featured_image ): ?>
					<div class="page-header-background"
						 style="background-image: url('<?php echo listable_get_inline_background_image( $image ); ?>')"></div><?php endif; ?>
				<div class="header-content">
					...
					if ( $categories ):
						...
						foreach ( $categories as $category ): ?>
							<li>
								<a href="<?php echo esc_sql( get_category_link( $category->cat_ID ) ); ?>"><?php echo $category->cat_name; ?></a>
							</li>
						<?php endforeach;
