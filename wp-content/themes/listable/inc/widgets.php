	...
	public function widget( $args, $instance ) {
		...
		<div class="listing-map-content">
			...
			<?php if ( ! empty( $get_directions_link ) ) { ?>
				<a href="<?php echo $get_directions_link; ?>" class="listing-address-directions" target="_blank"><?php esc_html_e( 'Abrir en Google Maps', 'listable' ); ?></a>
			<?php } ?>
			...
			<ul class="categories">
				...
				foreach ( $term_list as $key => $term ) : ?>
					...
					<?php
							...
							if($termId == 132 || $termId == 95 || $termId == 92 || $termId == 91){
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $photos ) ) :
			...
			<header class="listing-gallery__header">
				<span class="listing-gallery__title"><?php esc_html_e( 'Galería', 'listable' ); ?></span>
				<a href="<?php echo wp_get_attachment_url( intval( $photos[0] ) ); ?>" class="listing-gallery__all"><?php echo esc_html__( 'Imágenes', 'listable' ) . ' (' . count( $photos ) . ')'; ?></a>
			</header>
